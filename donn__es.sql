...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 29 mars 2024 à 14:24
...
INSERT INTO `données` (`N°`, `X`, `Y`, `Mois`, `Jour`, `FFMC`, `DMC`, `DC`, `ISI`, `Temps`, `RH`, `Vent`, `Pluie`, `Zone`) VALUES
(1, 0, 0, 'Mois', 'Jour', 'FFMC', 'DMC', 'DC', 'ISI', 'Temp', 'RH', 'Vent', 'Puie', 'Zone'),
...
--
ALTER TABLE `données`
  MODIFY `N°` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=519;
COMMIT;
